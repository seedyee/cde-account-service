...
public class AccountController {
    ...
    public ErrorInfo createAccount(@RequestBody final Map<String, String> account) {
    ...
    public Account getAccountInfo(@PathVariable final String accountId) {
        logger.info("query account started");
        final Account account = accountService.getAccountInfo(accountId);
        if (account == null) {
            final AccountNotFoundException accountNotFoundException = new AccountNotFoundException(Error.INVALID_ACCOUNT_ID.getCode(), errorHandler.getMessage(Error.INVALID_ACCOUNT_ID.toString()));
    ...
    public ErrorInfo updateAccountInfo(@PathVariable final String accountId, @RequestBody final Account account) {
    ...
    public ErrorInfo updateName(@PathVariable final String accountId,
    ...
    public ErrorInfo updatePassword(@PathVariable final String accountId,
                                    @RequestBody final Map<String, String> params) {
        ...
        if (!params.get("password1").equals(params.get("password2"))) {
            ...
            errorInfo = new ErrorInfo(Error.UNMATCHED_PASSWORD1_AND_PASSWORD2.getCode(), errorHandler.getMessage(Error.UNMATCHED_PASSWORD1_AND_PASSWORD2.toString()));
            return errorInfo;
        }
